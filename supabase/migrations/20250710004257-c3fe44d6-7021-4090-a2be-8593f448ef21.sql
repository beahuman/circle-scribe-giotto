...
CREATE INDEX idx_feature_usage_date ON public.feature_usage(DATE(created_at));
CREATE INDEX idx_user_sessions_user_date ON public.user_sessions(user_id, DATE(session_start));
