...
export const RADIUS_MAPPINGS = {
  ...
  'rounded-xl': 'rounded-md',    // Large buttons → standard button radius
  'rounded-lg': 'rounded-lg',    // Cards and panels (keep as-is)
  'rounded-md': 'rounded-md',    // Default components (keep as-is)
  'rounded-sm': 'rounded-sm',    // Micro elements (keep as-is)
...
export const COMPONENT_RADIUS_GUIDELINES = {
  ...
  cards: 'rounded-lg',          // Cards and panels use large radius
  modals: 'rounded-lg',         // Modals use large radius
